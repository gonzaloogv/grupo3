...
- [ ] Los enums coinciden con los ejemplos y errores documentados; `urls` acepta como máximo tres HTTP(S).
...
- [ ] El servidor fija eventId, analyzer, model, promptVersion, explanationSource y decisionSources; registra tiempos sin cuerpos de mensajes.
